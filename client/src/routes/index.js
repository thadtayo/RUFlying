...
import {LoginRegister, Home, CustomerProfile, EditUser, FlightSearch, Reservations, Flights, logout, MoreDetails, CreditCard, AllReservations} from "../pages";
    ...
    return (
        <Router>
            <Switch>
                ...
                <Route path = "/active-reservations" component = {Reservations}></Route>
                <Route path = "/logout" component = {logout}></Route>
                <Route path = "/moredetails" component = {MoreDetails}></Route>
                <Route path = "/creditcard" component = {CreditCard}></Route>
                <Route path = "/all-reservations" component = {AllReservations}></Route>
